...
# Horse (および Horse を継承した RaceHorse クラスを抽出)
my @all_animalls = qw( Horse RaceHorse Sheep Cow Mouse );
my @horses = grep $_->isa('Horse'), @all_animalls;
print "\$_->isa(): @horses\n";

my @all_animalls2 = qw( Horse RaceHorse Sheep Cow Mouse );
my @horses2 = grep ref $_ eq 'Horse', @all_animalls2;
print "ref eq: @horses2\n";

my $tv_horse = Horse->named("Mr. Ed");
my $ref = ref $tv_horse if ref $tv_horse eq 'Horse';
print "ref: $ref\n";
